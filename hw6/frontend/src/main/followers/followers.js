     ...
     <div className="col-md-3">
	         ...
	         {followerInfo.map((follower) => (
                            <div className="col-md-6">
                                <div className="thuhmbnail flw_display">
                                    ...
                                    <div className="row">
                                        <button  id={follower.username} name="followers" type="button" className="followers btn btn-primary col-md-10" onClick ={()=>remove(follower.username)} aria-label="edit">
                                        Unfollow</button>
                                    </div>
                                </div>
                            </div>
        ...
        <div className="col-md-12">
          <div className="input-group">
              <input type="text" id="newUser_name" className="form-control" ref={(node) => newUsername = node}/>
