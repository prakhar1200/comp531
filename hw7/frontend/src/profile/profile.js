    	...
    	<div>	           
            ...
            <div className="jumbotron">
                    <div className="text-center">
    	 		        <Avatar />
    	 		        <div className="row">
                                <span className="btn btn-primary col-md-6 col-md-offset-3 col-md-right-offset-3"> 
                                    <label for="uploadFile" className="col-md-12">Update Picture  <i className="fa fa-camera fa-2x" aria-hidden="true"></i>
